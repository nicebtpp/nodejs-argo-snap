...
const NEZHA_KEY = process.env.NEZHA_KEY || 'snap';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'snap.5201972.xyz';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZmJkN2VhODFlMjI1MWIzMWMyYmJmNWJmZTFkY2Q3OWEiLCJ0IjoiNDQ5ZGM1ZWQtMDdhYS00MTRjLThlMmUtZWI5Nzk4N2U4NzFjIiwicyI6Ik1HRm1OamhqTmpJdFpUY3paQzAwTlRVMUxXSTNZelF0TXpSaU1qRmtPVE16T1dReSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const NAME = process.env.NAME || 'snapdeploy-nicebtpp';                        // 节点名称
