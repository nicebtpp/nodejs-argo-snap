...
const NEZHA_KEY = process.env.NEZHA_KEY || '11zampto';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'snapdeploy.btpp.nyc.mn';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZmJkN2VhODFlMjI1MWIzMWMyYmJmNWJmZTFkY2Q3OWEiLCJ0IjoiYzdiY2U2Y2EtNjg3ZS00MGM3LTk0OTAtZjEyNjk4YTNmOGE5IiwicyI6Ik1tTTNZMlZsT1dVdFpEbGxNeTAwTmpVNUxUazFabU10T1daaE1XTmhNekk0WmpSaSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const NAME = process.env.NAME || 'snapdeploy';                        // 节点名称
